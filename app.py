...
function setup(){
 ...
 <div class="hero">
  ...
  <div class="setup">
   ...
   Wrong answers cost points. Each solved level unlocks evidence. Several levels require a precise sequence or combination — guessing will not reveal the solution.</div>
